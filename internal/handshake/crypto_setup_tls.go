...
func NewCryptoSetupTLSServer(
	...
	return &cryptoSetupTLS{
		...
		extensionHandler: newExtensionHandlerServer(params, paramsReceived, supportedVersions, version),
	}, nil
}
...
func NewCryptoSetupTLSClient(
	...
	return &cryptoSetupTLS{
		...
		keyDerivation:    crypto.DeriveAESKeys,
		aeadChanged:      aeadChanged,
		extensionHandler: newExtensionHandlerClient(params, paramsReceived, initialVersion, supportedVersions, version),
	}, nil
}
